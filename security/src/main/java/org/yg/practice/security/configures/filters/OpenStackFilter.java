package org.yg.practice.security.configures.filters;
...
public class OpenStackFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        //Provider 에서 username 과 password 정보를 수집된 것과 비교함
        return this.getAuthenticationManager().authenticate(usernamePasswordAuthenticationToken); // provider 로 넘어가는 구간 
    }
