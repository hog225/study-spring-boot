...
//    }
    ...
    @Bean
    @JobScope
    public Step createArticleStep(JobRepository jobRepository, PlatformTransactionManager transactionManager){
        return new StepBuilder("createArticleStep", jobRepository)
//                .tasklet((contribution, chunkContext) -> {
//                    log.info("Step !!!!!!!!");
//                    return RepeatStatus.FINISHED;
//                })
                .<ArticleModel, Article>chunk(10, transactionManager)// 쉽게 말해서 update 하는 사이즈 chunkSize개씩 모아서 커밋 함
